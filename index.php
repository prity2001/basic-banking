...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="index.php">
        ...
        <img src="images/my_logo3.png" alt="logo" style="width:250px;">
      </a>
  ...
  <section class="topContent">
    ...
    <div class="topContentImg">
      <img src="images/download.jpg" alt="Banking">
    </div>
  </section>
  <!-- End Home -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:400px;" src="images/bank2.png" alt="TSF Bank">
        </div>
